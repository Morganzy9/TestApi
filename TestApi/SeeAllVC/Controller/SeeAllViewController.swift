...
extension SeeAllViewController {
    ...
    private func addViews() {
        view.addSubview(trendingNowCollectionView)
    }
    
    private func setConstraints() {
        trendingNowCollectionView.snp.makeConstraints { make in
    ...
    private func registerCells() {
        trendingNowCollectionView.register(SeeAllTrendingCell.self, forCellWithReuseIdentifier: Theme.trending)
    }
    ...
    private func fetchRecipeImage(id: Int) {
